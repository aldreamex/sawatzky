...
export const getCreateLegalEntityIsEdit = (state: StateSchema) => state.createLegalEntityForm?.isEdit;
export const getCreateLegalEntityIsView = (state: StateSchema) => state.createLegalEntityForm?.isView;
export const getCreateLegalEntityId = (state: StateSchema) => state.createLegalEntityForm?.legalEntityId;
