...
export const getCreateEmployeeIsEdit = (state: StateSchema) => state.createEmployee?.isEdit;
export const getCreateEmployeeIsView = (state: StateSchema) => state.createEmployee?.isView;
export const getCreateEmployeeId = (state: StateSchema) => state.createEmployee?.employeeId;
...
// change password
export const getCreateEmployeeChangePasswordData = (state: StateSchema) => state.createEmployee?.changePasswordData;
export const getCreateEmployeeNewPassword = (state: StateSchema) => state.createEmployee?.changePasswordData.new_password;
export const getCreateEmployeeOldPassword = (state: StateSchema) => state.createEmployee?.changePasswordData.old_password;
